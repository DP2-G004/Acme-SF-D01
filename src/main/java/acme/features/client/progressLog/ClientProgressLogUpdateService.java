...
public class ClientProgressLogUpdateService extends AbstractService<Client, Progress> {
	...
	public void authorise() {
		...
		final boolean authorise = progress != null && progress.isDraftMode() && principal.hasRole(Client.class) && progress.getContract().getCustomerName().getUserAccount().getId() == userAccountId;
