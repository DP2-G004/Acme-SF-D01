...
public class ClientContractDeleteService extends AbstractService<Client, Contract> {
	...
	public void perform(final Contract object) {
		...
		Collection<Progress> progress = this.repository.findProgressByContractId(object.getId());
	...
	public void unbind(final Contract object) {
		...
		Dataset dataset = super.unbind(object, "contractCode", "instantiation", "providerName", "customerName", "goals", "budget", "project");
