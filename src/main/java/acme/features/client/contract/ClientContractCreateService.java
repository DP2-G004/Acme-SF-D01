...
public class ClientContractCreateService extends AbstractService<Client, Contract> {
	...
	public void load() {
		...
		object.setCustomerName(this.repository.findClientById(id));
	...
	public void bind(final Contract object) {
		...
		super.bind(object, "contractCode", "instantiationMoment", "providerName", "customerName", "goals", "budget", "project", "draftMode");
	...
	public void validate(final Contract object) {
		...
		if (!super.getBuffer().getErrors().hasErrors("budget")) {
			final boolean budget = object.getBudget().getAmount() > object.getProject().getCost().getAmount();
	...
	public void unbind(final Contract object) {
		...
		Dataset dataset = super.unbind(object, "contractCode", "instantiationMoment", "providerName", "customerName", "goals", "budget", "project", "draftMode");
